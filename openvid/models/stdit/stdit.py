...
from openvid.acceleration.checkpoint import auto_grad_checkpoint
...
from openvid.models.layers.blocks import (
    Attention,
    CaptionEmbedder,
...
from openvid.registry import MODELS
from openvid.utils.ckpt_utils import load_checkpoint
import ipdb
...
def STDiT_XL_2(from_pretrained=None, del_y_embedder=False, **kwargs):
    ...
    if from_pretrained is not None:
        load_checkpoint(model, from_pretrained, del_y_embedder)
    return model
