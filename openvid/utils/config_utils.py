...
def parse_args(training=False):
    ...
    if not training:
        parser.add_argument("--config", default="configs/mvdit/inference/16x512x512.py", type=str, help="model config file path")
        # parser.add_argument("--config", default="configs/stdit/inference/16x512x512.py", type=str, help="model config file path")
        # parser.add_argument("--config", default="configs/stdit/inference/16x1024x1024.py", type=str, help="model config file path")
        ...
        parser.add_argument("--config", default="configs/mvdit/train/16x512x512.py", type=str, help="model config file path")
