...
## News 🚀🚀🚀
- **[2025.02.28]** 🤗 Thanks [@Binglei](https://github.com/phil329), [**OpenVid-1M-mapping**](https://huggingface.co/datasets/phil329/OpenVid-1M-mapping) was developed to map the video names in the CSV file to their file paths in the unzipped files. It will be helpful if you only want to use part of the dataset and don't want to download all of it.
