...
## News 🚀🚀🚀
- **[2025.05.30]** 🤗 We have uploaded a separate [**OpenVidHD-0.4M**](https://huggingface.co/datasets/nkp37/OpenVid-1M/tree/main/OpenVidHD) for convenient download. This will be helpful if you only want to use OpenVidHD-0.4M, and it requires about 4.5TB of storage space.
